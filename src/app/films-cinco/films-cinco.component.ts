...
@Component({
  selector: 'app-films-cinco',
  templateUrl: './films-cinco.component.html',
  styleUrls: ['./films-cinco.component.css']
})
export class FilmsCincoComponent implements OnInit {
  ...
  getFilm() {
    this.filmService.getFilm('6').subscribe((filmFromAPI: Film) => {
