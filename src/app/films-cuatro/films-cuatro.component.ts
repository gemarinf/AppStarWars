...
@Component({
  selector: 'app-films-cuatro',
  templateUrl: './films-cuatro.component.html',
  styleUrls: ['./films-cuatro.component.css']
})
export class FilmsCuatroComponent implements OnInit {
